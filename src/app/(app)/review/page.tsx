...
import { db, accounts as accountsTable, categories as categoriesTable } from '@/lib/db'
...
export default async function ReviewPage() {
  ...
  const [pendingMovements, { accounts, categories }, transferAccounts, transferCategories] = await Promise.all([
