    ...
    >
      ...
      <div style={{ flexShrink: 0, marginLeft: 8 }}>
        <span style={{
          ...
          {isTransfer ? '' : m.type === 'income' ? '+' : '-'}{formatCurrency(m.currency === 'USD' && m.amountUsd ? m.amountUsd : m.amount, m.currency)}
        </span>
        {m.currency === 'USD' && (
          <div style={{ fontSize: 11, color: '#9ca3af', textAlign: 'right', marginTop: 1 }}>
            USD
          </div>
        )}
      </div>
